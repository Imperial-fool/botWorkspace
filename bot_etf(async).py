...
def main():
 ...
 future = [executor.submit(run_bot, bot) for bot in bots]
 while True:
    
    concurrent.futures.wait(future, return_when=concurrent.futures.ALL_COMPLETED)
